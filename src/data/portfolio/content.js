...
export const portfolioContent = {
  hero: {
    ...
    briefKicker: '当前实践',
    briefCopy: '在盛大健康数据事业群 Lyncia Lab 参与 AI 心理健康产品，推进 C 端女性日常陪伴与 B 端咨询师陪练的研究、产品设计、AI 评测与体验验证。',
    actions: [
    ...
    timeline: [
      ...
      },
      {
        ...
        summary: '参与 AI 心理健康产品的 C 端女性日常陪伴与 B 端咨询师陪练双线探索。',
        details: ['覆盖竞品与用户研究、产品设计、角色一致性与心理安全评测，以及咨询师陪练的体验验证。'],
      },
    ],
  },
  capabilityRail: [
    ...
    },
    {
      ...
      proof: '新传 Mind 在线运行 · 灵溪大院 C 端验证 Demo',
    },
    {
      index: '03',
      eyebrow: '评估迭代',
  ...
  lynciaCase: {
    ...
    summary: '作为盛大灵溪团队的 C 端验证项目，我负责多角色社区 Demo 的产品设计与原型开发，并建立角色一致性与心理安全评测标准。',
    evidence: [
      {
        label: '用户判断',
      ...
      {
        label: '我的工作',
        value: '将“无限聊天”改为受关系规则与安全评测约束的社区体验，设计角色人设、关系、渐进式熟悉、主动触发与用户自我分身等交互。',
      },
      {
        label: '安全边界',
    ...
    metrics: [
      { value: '多角色', label: '社区关系体验' },
      { value: '可体验', label: 'Vite + React Demo' },
      { value: '6 维 + 安全', label: '一致性与安全评测' },
    ],
  },
  productNotes: {
    eyebrow: '产品心得 · 真人感评测',
    ...
    intro:
      '在灵溪大院 demo 中，我把“真人感”从主观印象拆成身份、语言、关系、情境、边界与记忆六类可观察行为；安全单独判定，不能被高分掩盖。',
    steps: [
      {
        index: '01',
      ...
      },
      {
        ...
        description: '身份事实、语言风格、关系阶段、情境时间、边界与记忆一致性分别评分；每一维都用真实失败案例锚定中间档。',
      },
      {
        index: '04',
  ...
  methods: [
    {
      ...
      badge: 'User Insight',
      description:
        '我习惯先通过访谈、观察和结构化追问把需求拆开，而不是一上来堆功能。无论是数字分身、陪伴 Agent 还是备考系统，都会先判断用户真正卡在哪里。',
    },
    {
      title: '把 AI 能力落到可信闭环',
  ...
  experiences: [
    {
      ...
      role: '灵溪 AI Intern',
      summary:
        '围绕 C 端女性心理陪伴与 B 端咨询师陪练双线，参与竞品与用户研究、产品设计、AI 评测与体验验证。',
      highlights: [
        '基于竞品、用户访谈与调研参与 C 端定位迭代；独立完成围绝经期方向机会论证，并由案头调研输出决策版 BRD。',
        '承担“灵溪大院”方向 Demo 设计：设计多角色社区的角色人设、关系、渐进式熟悉、主动触发与用户自我分身等交互，作为 C 端验证项目展示。',
        '负责竞品与市场研究，覆盖 44 款海外与中国区同类产品；识别出仅以应用商店为入口的系统性盲区，并补齐商店外检索通道。',
        '建立角色一致性与心理安全评测框架；参与咨询师陪练体验评估，并围绕上下文残留、高风险提示和缺失信息等问题输出 P0/P1/P2 分级建议。',
      ],
    },
    {
      category: 'internship',
    ...
    },
    {
      ...
      highlights: [
        ...
        '以“答案可信度”为核心指标，设计 RAG 引用回链机制；沉淀 64 份文档、100 所院校 8,448 道真题。',
    ...
    },
    {
      ...
      role: '团队实践 / 原型开发',
      summary:
        '盛大灵溪团队 C 端验证项目：面向在育儿、关系与自我空间中有日常情绪困扰的妈妈用户，设计并开发多角色社区 AI Demo。',
      highlights: [
        '针对一对一陪伴易形成依赖、角色体验难以验证的问题，将“无限聊天”改为受关系规则与安全评测约束的社区体验。',
        '设计多角色关系、渐进式熟悉、主动触发与用户自我分身等规则，使用 Vite、React 与 TypeScript 完成可体验 Demo。',
        '建立身份、语言、关系、情境、边界、记忆六维角色一致性评测与安全一票否决机制，使体验问题可定位、版本变更可回归。',
      ],
    },
    {
      category: 'personal',
  ...
  works: [
    ...
    },
    {
      type: 'external',
      title: '灵溪大院',
      subtitle: '多角色社区 AI Demo',
      description:
        '面向在育儿、关系与自我空间中有日常情绪困扰的妈妈用户，把一对一陪伴改造成可被关系规则与安全评测约束的多角色社区体验。',
      ownership: '团队实践 / 原型开发：负责产品设计、可体验 Demo 与角色一致性评测',
      practiceHighlights: ['设计多角色关系、渐进式熟悉、主动触发与用户自我分身等交互，作为 C 端验证项目展示', '使用 Vite、React 与 TypeScript 完成可体验 Demo 及语音链路复测', '建立身份、语言、关系、情境、边界、记忆六维角色一致性评测与安全一票否决机制'],
      tech: ['AI Agent', '角色设计', '产品原型', '安全评测'],
      screenshot: '/portfolio/covers/lyncia-dayuan-demo.webp',
      screenshotAlt: '灵溪大院多角色 AI 陪伴产品 demo',
      mediaFormat: 'wide',
      mediaLabel: '团队 C 端验证 Demo · 在线体验',
  ...
  caseStudies: [
    ...
    {
      title: '灵溪大院 · 多角色社区 AI Demo',
      hook: '情绪陪伴不只要“会聊天”：角色必须有活人感，关系也必须有边界。',
      context:
        '针对一对一陪伴易形成依赖、角色体验难以验证的问题，我把核心任务重定义为：建立可被关系规则与安全评测约束的社区体验。',
      decisions: [
        '设计多角色人设、关系、渐进式熟悉、主动触发与用户自我分身等规则，避免用单轮对话伪造关系',
        '使用 Vite、React 与 TypeScript 完成可体验 Demo，并复测语音链路',
        '用身份、语言、关系、情境、边界、记忆六维评测角色一致性，安全红线一票否决',
      ],
      outcome:
        '完成多角色社区 AI Demo，并将角色一致性与安全机制写入可回归的评测标准，使体验问题可定位、版本变更可复查。',
    },
  ],
  contact: {
    intro:
